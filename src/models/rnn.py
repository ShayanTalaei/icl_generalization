"""Classical RNN wrapper (LSTM/GRU) for in-context learning.

For modern RNN architectures (Linear Attention, DeltaNet, Mamba, etc.),
see src/models/miras/ which implements the MIRAS framework.
"""
...
class RNNModel(SeqModel):
    ...
    Builds an interleaved sequence [x1, y1, x2, y2, ..., x_query]
    and processes it autoregressively.  Predictions at x-positions.
    """
